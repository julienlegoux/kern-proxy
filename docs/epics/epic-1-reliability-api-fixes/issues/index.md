...
* [Adopt the retry helper in the google, vertex, and mistral adapters](./04-retry-google-vertex-mistral.md) - M, pr-open, [#90](https://github.com/julienlegoux/kern-proxy/issues/90)
