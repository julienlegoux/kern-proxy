...
* [Adopt the retry helper in the anthropic and openaicompletions adapters](./02-retry-anthropic-openaicompletions.md) - M, in-progress, [#88](https://github.com/julienlegoux/kern-proxy/issues/88)
