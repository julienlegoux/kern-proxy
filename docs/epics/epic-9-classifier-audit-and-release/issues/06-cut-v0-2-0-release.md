...
Near-zero diff by design — the PR is a merge of `develop` into `main`, not a
change. The reviewable unit is the release itself: the changelog section, the
green CI run, and the tag.
