...
* [Collapse the anthropic and codex login flows onto upstream's always-racing manual-code prompt](./08-anthropic-codex-login-race.md) - M, open, [#177](https://github.com/kern-ia/kern-link/issues/177)
