...
* [Auth & credentials](auth.md) - How kern-proxy resolves provider credentials — env API keys, the persistent credential store, the pi-ai login CLI, and per-provider OAuth flows.
